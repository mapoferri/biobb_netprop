...
def gda_disgenet(input_file_path: str, output_csv_path: str, properties: dict = None, **kwargs) -> int:
...
def main():
    ...
    required_args.add_argument('-output_csv_path', required=True, help='Description for the output file path. Accepted formats: json, csv or html.')
