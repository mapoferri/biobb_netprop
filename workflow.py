...
from biobb_netprop import netprop
from biobb_netprop.netprop import parsehippie
from biobb_netprop.netprop import maknodes
from biobb_netprop.netprop import call_netprop
from biobb_netprop.netprop import gda_disgenet
from biobb_netprop.netprop import vda_disgenet
from biobb_netprop.netprop import dda_disgenet
from biobb_netprop.netprop import ga_disgenet
from biobb_netprop.netprop import va_disgenet
from biobb_netprop.netprop import da_disgenet
...
def main(args):
    ...
    maknodes.maknodes(**global_paths["step3_making_nodes"], properties=global_prop["step3_making_nodes"])

    global_log.info("step4_call_guild: paths and prop {} ".format(global_prop["step4_call_guild"]))
    global_log.info("output_netscore_path {} ".format(args.output_netscore_path))

    global_log.info("step4_call_guild: Calling Guild algo over Network")
    call_netprop.call_netprop(**global_paths["step4_call_guild"], properties=global_prop["step4_call_guild"])

    global_log.info("step4_call_guild: Calling Guild algo over Network {}".format(global_paths["step4_call_guild"]["output_path"]))
